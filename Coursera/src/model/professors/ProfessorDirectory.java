...
public class ProfessorDirectory {
    public static ArrayList <Professor> professorDirectory = new ArrayList<>();
    public static Professor currentProfessor;
    
    public static void updateCurrentProfessor(Professor professor)
    {
...
//            }
    ...
    public static Professor getRequiredUser(String userName){
